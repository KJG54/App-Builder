...
API response timeout issue

This issue has occurred 5 times across 1 agent(s).

---

## Symptoms

- Issue detected in verification: TEST-005
- Compliance impact: Average score reduced by 20.0%
- Affects agents: backend
...
- **Frequency:** 5 occurrences (high)
- **Affected Teams:** backend
- **Quality Loss:** 20.0% compliance reduction
